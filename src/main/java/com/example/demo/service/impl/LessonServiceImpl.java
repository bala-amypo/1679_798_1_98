...
public class LessonServiceImpl implements LessonService {
    ...
    public MicroLesson updateLesson(Long lessonId, MicroLesson lesson) {
        ...
        if (lesson.getDifficulty() != null) existing.setDifficulty(lesson.getDifficulty());
        if (lesson.getTag() != null) existing.setTag(lesson.getTag());
        if (lesson.getDurationMinutes() > 0) existing.setDurationMinutes(lesson.getDurationMinutes());
